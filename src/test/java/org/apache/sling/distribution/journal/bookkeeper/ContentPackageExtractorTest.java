...
public class ContentPackageExtractorTest {
    ...
    public void before() throws RepositoryException {
        ...
        when(packaging.getPackageManager(Mockito.any(Session.class))).thenReturn(packageManager);
    ...
    public void testFailedInstall() throws Exception {
        ...
        doThrow(new PackageException()).when(pkg).install(Mockito.any(ImportOptions.class));
    ...
    public void testFailedInstallWithError() throws Exception {
        ...
        doAnswer(errorAndThrow).when(pkg).install(any(ImportOptions.class));
